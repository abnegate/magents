...
Per-agent usage (Claude/Grok/Codex native files; Cursor/OpenCode `rate-limits.json`) at ~90% auto-hands off to another live session unless `MAGENTS_AUTO_HANDOFF=0`.
