...
Publishing a GitHub Release pushes GHCR (`ghcr.io/abnegate/magents`), attaches musl/darwin binaries, and updates `abnegate/homebrew-tap` plus `abnegate/apt-repo`. Pushing a tag alone does not.
